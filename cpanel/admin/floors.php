  ...
  if (isset($_SESSION['AdminId']))
  {
    if ($Page == 'Floors')
    {
      ...
      <section class="table-customize-floor my-3">
        <div class="container">
          <h1 class="text-center text-light my-3"><?php echo $lang['Manage'] . $lang['Floors']; ?></h1>
          <div class="table-responsive">
            <table class="table table-dark table-hover table-bordered table-striped text-center">
              ...
              <button  type="button" class="btn ButtonRemoveFloor btn-danger my-2 hvr-shrink shadow-none" data-bs-toggle="modal" data-bs-target="#confirmTheDelete" data-balloon-pos="right" data-balloon-nofocus data-ball aria-label="<?php echo $lang['RemoveAFloor']; ?>">
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" class="btn btn-danger" id="ButtonRemoveFloor" data-bs-dismiss="modal"><?php echo $lang['Delete']; ?></button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <thead>
                <tr>
                  <th scope="col"><?php echo $lang['FloorId']; ?></th>
                  <th scope="col"><?php echo $lang['FlatCount']; ?></th>
                  <th scope="col"><?php echo $lang['AddedBy']; ?></th>
                  <th scope="col"><?php echo $lang['Display']; ?></th>
                </tr>
              </thead>
              <tbody class="responseFloor align-middle">
    ...
    elseif ($Page == 'Flats') 
    {
      ...
      if ($SelectFloor->rowCount() > 0)
      {
        ...
        <div class="modal fade" id="NotFeatureInFlat" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="WarningTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title text-warning" id="WarningTitle"><i class="fas fa-exclamation me-2 fs-5"></i><?php echo $lang['Warning']; ?></h5>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-warning shadow-none" data-bs-dismiss="modal" onclick="history.back();"><?php echo $lang['Back']; ?></button>
                <a href="features.php" class="btn btn-danger shadow-none"><?php echo $lang['AddNow']; ?></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <section class="table-customize-flat my-3">
          <div class="container">
            <h1 class="text-center text-light my-3"><?php echo $lang['Manage'] . $lang['Flats']; ?></h1>
            <!-- Start Add Flat -->
            ...
            <div class="table-responsive">
              <table class="table table-dark table-hover table-bordered table-striped text-center">
                <thead>
                  <tr>
                    <th scope="col"><?php echo $lang['FlatId']; ?></th>
                    <th scope="col"><?php echo $lang['RoomsCount']; ?></th>
                    <th scope="col"><?php echo $lang['View']; ?></th>
                    <th scope="col"><?php echo $lang['FlatArea']; ?></th>
                    <th scope="col"><?php echo $lang['AddedBy']; ?></th>
                    <th scope="col"><?php echo $lang['Processes']; ?></th>
                  </tr>
                </thead>
                <tbody class="responseFlat align-middle">
    ...
    elseif ($Page == 'NewFlat')
    {
      ...
      if ($SelectFloor->rowCount() > 0)
      {
        ...
        <nav class="p-2 mb-2 rounded navBredcrumb" aria-label="breadcrumb">
          <div class="container">
            <ol class="breadcrumb my-3">
              <li class="breadcrumb-item"><a class="breadcrumb-link fw-bold text-decoration-none text-uppercase" href="index.php"><?php echo $lang['ControlPanel']; ?></a></li>
              <li class="breadcrumb-item"><a class="breadcrumb-link fw-bold text-decoration-none text-uppercase" href="floors.php"><?php echo $lang['Floors']; ?></a></li>
              <li class="breadcrumb-item"><a class="breadcrumb-link fw-bold text-decoration-none text-uppercase" href="floors.php?Page=Flats&Id=<?php echo $FloorId; ?>"><?php echo $lang['Floor'],' [ ', $FloorId, ' ]'; ?></a></li>
        ...
        <section class="SectionAddFlat my-3">
          <div class="container">
            <h1 class="text-center text-light my-3"><?php echo $lang['NewFlat']; ?></h1>
            <!-- Start Form Add Flat -->
            <form class="row was-validated text-light FormNewFlat" id="FormNewFlat">
              ...
              <div class="col-2 mb-2 ps-0 d-flex flex-column justify-content-end align-items-start" id="buttonAddRoom">
                <span class="btn btn-success"><?php echo $lang['Room']; ?></span>
              </div>
