<?php
  ...
  if (isset($_SESSION['AdminId']))
  {
    ...
    <section class="table-customize-employees my-3">
      <div class="container">
        <h1 class="text-center text-light my-3"><?php echo $lang['Manage'] . $lang['Employees']; ?></h1>
        <!-- Start Modal For Add And Edit Employees -->
        <button  type="submit" class="btn btn-success ButtonFormEmployees my-2 hvr-forward shadow-none" id="ButtonFormEmployees" data-bs-toggle="modal" data-bs-target="#comfirmAddAndEditEmployees" data-balloon-pos="right" data-balloon-nofocus data-ball aria-label="<?php echo $lang['NewEmployee']; ?>">
        ...
        <div class="modal fade CostumizeModalEmployees" id="comfirmAddAndEditEmployees" data-bs-keyboard="false" tabindex="-1" aria-labelledby="HeaderAddEditEmployees" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered flex-column justify-content-center">
            <div class="modal-content text-light" id="AddEditEmployeesTemplate">
                  ...
                  <div class="row g-2 mb-3">
                    <div class="col-12">
                      <div class="form-floating m-1">
                        ...
                        <label class="text-white" for="UserName"><i class="far fa-user-circle me-1"></i><?php echo $lang['UserName']; ?></label>
                      </div>
                    </div>
                    <div class="col-12">
                      <div class="form-floating m-1">
                        <input type="password" class="form-control" name="Password" id="Password" minlength="8" placeholder="Password" required>
                        <label class="text-white" for="Password"><i class="fas fa-user-lock me-1"></i><?php echo $lang['Password']; ?></label>
                      </div>
                    </div>
                  </div>
                  <div class="modal-footer pt-2 pb-0">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo $lang['Close']; ?></button>
                    <button type="submit" id="ButtonAddEmployees" class="btn btn-primary"><?php echo $lang['Add']; ?></button>
                  </div>
                </form>
              </div>
            </div>
        ...
        <div class="modal fade" id="confirmTheBlock" data-bs-keyboard="false" tabindex="-1" aria-labelledby="WarningTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo $lang['Close']; ?></button>
                <button type="button" class="btn btn-danger" id="ButtonBlockEmployee" ><?php echo $lang['Block']; ?></button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="table-responsive overflow-visible">
          <table class="table table-dark table-hover table-bordered table-striped text-center" id="jsTable">
            <thead>
              <tr>
                <th scope="col"><?php echo $lang['EmpId']; ?></th>
                <th scope="col"><?php echo $lang['UserName']; ?></th>
                <th scope="col"><?php echo $lang['AddedBy']; ?></th>
                <th scope="col"><?php echo $lang['Processes']; ?></th>
              </tr>
            </thead>
            <tbody class="responseEmployees align-middle">
